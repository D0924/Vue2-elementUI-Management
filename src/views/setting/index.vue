<template>
  <div class="dashboard-container">
      ...
      <el-tabs>
        <el-tab-pane label="角色管理">
          ...
          <el-row type="flex" justify="end" style="height: 60px" align="middle">
            ...
            <el-pagination :total="page.total" :page-size="page.pagesize" :current-page.sync="page.page" layout="prev, pager, next" @current-change="getRoleList" />
          </el-row>
        </el-tab-pane>
        <el-tab-pane label="公司信息">
          ...
          <el-form label-width="120px" style="margin-top:50px">
            <el-form-item label="公司名称">
              ...
              <el-input value="绛河科技有限公司" disabled style="width:400px" />
            </el-form-item>
            <el-form-item label="公司地址">
              <!-- <el-input v-model="formData.companyAddress" disabled style="width:400px" /> -->
              <el-input value="江西景德镇市" disabled style="width:400px" />
            </el-form-item>
            <el-form-item label="公司邮箱">
              <!-- <el-input v-model="formData.mailbox" disabled style="width:400px" /> -->
              <el-input value="2437757398@qq.com" disabled style="width:400px" />
            </el-form-item>
            <el-form-item label="备注">
              <!-- <el-input v-model="formData.remarks" type="textarea" :rows="3" disabled style="width:400px" /> -->
              <el-input value="内测学习所用" type="textarea" :rows="3" disabled style="width:400px" />
            </el-form-item>
          </el-form>
        </el-tab-pane>
      </el-tabs>
    ...
    <el-dialog title="分配权限" :visible="showPermDialog" @close="btnPermCancel">
      ...
      <el-tree ref="permTree" :data="permData" :props="defaultProps" default-expand-all="" show-checkbox :default-checked-keys="selectChecks" :check-strictly="true" node-key="id" />
      <!-- 确定和取消按钮 -->
